...
import com.zitech.mddemo.rippleeffect.CustomAdapter;
import com.zitech.mddemo.rippleeffect.CustomListViewAdapter;
import com.zitech.mddemo.rippleeffect.OnTapListener;
...
public class RippleEffectAct extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isRecyclerview)
            setContentView(R.layout.act_ripple_recycler);
        else
            setContentView(R.layout.act_ripple_list);
